...
# Add the parent folder (lib/) to Python path
...
# Optional: run tests manually if you want
if __name__ == "__main__":
    tests = TestCashRegister()
    tests.test_discount_attribute()
    tests.test_total_attribute()
    tests.test_items_attribute()
    tests.test_add_item()
    tests.test_add_item_optional_quantity()
    tests.test_add_item_with_multiple_items()
    tests.test_apply_discount()
    tests.test_apply_discount_success_message()
    tests.test_apply_discount_reduces_total()
    tests.test_apply_discount_when_no_discount()
    tests.test_items_list_without_multiples()
    tests.test_items_list_with_multiples()
    tests.test_void_last_transaction()
    tests.test_void_last_transaction_with_multiples()
